...
- (id)initWithViewControllers:(NSArray *)vCs MenuTitles:(NSArray *)titles andImagesTitles:(NSArray *)imgTitles {
    ...
    if (self) {
        ...
        self.menuColor = [UIColor colorWithPatternImage: [UIImage imageNamed:@"mainBack.jpg"]];//[UIColor colorWithRed:65.0 / 255.0 green:62.f / 255.f blue:79.f / 255.f alpha:1];
...
- (void)viewDidLoad {
    ...
    [navBar setBackgroundImage:[UIImage imageNamed:@"pp.jpg"] forBarMetrics:UIBarMetricsDefault];
