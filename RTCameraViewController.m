...
- (void)viewDidLoad {
    ...
    //------ 蒙版-------//
    UIImageView* imageView = [[UIImageView alloc] initWithFrame:CGRectMake(0, (screenRect.size.height-150-screenRect.size.width*7.f/5.f)/2, screenRect.size.width, screenRect.size.width*7.f/5.f)];
